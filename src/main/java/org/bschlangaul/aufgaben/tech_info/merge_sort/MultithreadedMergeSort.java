...
// https://stackoverflow.com/questions/34580668/multithreaded-merge-sort-adding-additional-threads/34624321#34624321
  ...
  private class MergeSortWorker implements Runnable {
    ...
    public void run() {
      ...
      while (nearFragment != null) {
        // there's more work: merge two consecutives sorted fragments, (begin, end) and
        // nearFragment
        int middle;
