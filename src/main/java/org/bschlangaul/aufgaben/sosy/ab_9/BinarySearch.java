package org.bschlangaul.aufgaben.sosy.ab_9;

/**
 * BinarySearch.java
 *
 * Eine Implementierung der ”BinaereSuche” mit einem iterativen Algorithmus
 */
class BinarySearch {
  /**
   * BinaereSuche
   ...
   * Genau dann wenn returnValue == −1 gibt es kein k mit 0 <= k < a.length und
   * a[k]==item.
   */
