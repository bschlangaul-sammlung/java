...
public class In {
  ...
  /**
   * Read a raw character (byte). If an attempt is made to read beyond the end of
  ...
  /**
   * Read a character, but skip white spaces (byte). If an attempt is made to read
  ...
  /**
   * Read the whole file. This method reads from the current position to the end
  ...
  /**
   * Read an integer. This method skips white space and tries to read an integer.
  ...
  /**
   * Read a long integer. This method skips white space and tries to read a long
  ...
  /**
   * Read a float value. This method skips white space and tries to read a float
  ...
  /**
   * Read a double value. This method skips white space and tries to read a double
  ...
  /**
   * Open a text file for reading The text file with the name fn is opened as the
  ...
  /**
   * Check if the previous operation was successful. This method returns true if
