...
/**
 * https://github.com/eugenp/tutorials/blob/master/algorithms-sorting/src/main/java/com/baeldung/algorithms/bucketsort/IntegerBucketSorter.java
 */
public class Bucket implements Sorter<Integer> {
